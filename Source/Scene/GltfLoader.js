 ...
 * @param {Resource|String} [options.basePath] The base path that paths in the glTF JSON are relative to. If not provided the base path defaults to the resource path.
